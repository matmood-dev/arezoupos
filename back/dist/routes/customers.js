 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:customerid', authenticateToken, requireAdminForDelete, validateIdParam, async (req, res) => {
    try {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/', authenticateToken, requireAdminForDelete, validateCustomerCreation, handleValidationErrors, async (req, res) => {
    try {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:customerid', authenticateToken, requireAdminForDelete, validateIdParam, validateCustomerUpdate, handleValidationErrors, async (req, res) => {
    try {
        const { customerid } = req.params;
        const { name, email, phone, address } = req.body;
