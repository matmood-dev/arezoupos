 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:userid', authenticateToken, requireAdminOrSelf, validateIdParam, async (req, res) => {
    try {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/', authenticateToken, requireAdmin, validateUserCreation, handleValidationErrors, async (req, res) => {
    try {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:userid', authenticateToken, requireAdminOrSelf, validateIdParam, validateUserUpdate, handleValidationErrors, async (req, res) => {
    try {
        const { userid } = req.params;
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/:userid', authenticateToken, requireAdmin, validateIdParam, async (req, res) => {
    try {
        const { userid } = req.params;
        const result = await query(`
      DELETE FROM users
