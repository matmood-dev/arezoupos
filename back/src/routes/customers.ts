 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:customerid', authenticateToken, requireAdminForDelete, validateIdParam, async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/', authenticateToken, requireAdminForDelete, validateCustomerCreation, handleValidationErrors, async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:customerid', authenticateToken, requireAdminForDelete, validateIdParam, validateCustomerUpdate, handleValidationErrors, async (req: Request, res: Response): Promise<void> => {
  try {
    const { customerid } = req.params;
