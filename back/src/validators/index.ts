...
export const validateItemCreation: ValidationChain[] = [
  body('name')
    .trim()
...
export const validateItemUpdate: ValidationChain[] = [
  body('name')
    .optional()
    .trim()
    .isLength({ min: 1, max: 100 })
...
export const validateCustomerCreation: ValidationChain[] = [
  body('name')
    .trim()
    .isLength({ min: 2, max: 100 })
...
export const validateCustomerUpdate: ValidationChain[] = [
  body('name')
    .optional()
    .trim()
    .isLength({ min: 2, max: 100 })
...
export const validateOrderUpdate: ValidationChain[] = [
  body('status')
    .optional()
...
export const validateBranchCreate: ValidationChain[] = [
  body('name')
    .trim()
    .isLength({ min: 1, max: 255 })
...
export const validateBranchUpdate: ValidationChain[] = [
  body('name')
    .optional()
    .trim()
    .isLength({ min: 1, max: 255 })
...
export const validateCategoryCreate: ValidationChain[] = [
  body('name')
    .trim()
    .isLength({ min: 1, max: 100 })
